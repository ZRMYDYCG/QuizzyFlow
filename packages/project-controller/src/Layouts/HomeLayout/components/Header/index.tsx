...
const HeaderComponent: React.FC = () => {
  ...
  const renderMobileMenu = () => (
    <Menu
      ...
      items={[
        ...
        { label: '登录', key: 'login' },
        {
          label: <Button type="primary">免费使用</Button>,
          key: 'free-use',
        },
      ]}
    />
  ...
  return (
    <Header
      ref={headerRef}
      className="px-8 fixed top-0 w-full z-[66] transition-background duration-300"
            ...
            <div className="space-x-6 text-black">
              ...
              >
                ...
                >
                  应用展示{' '}
                  <DownOutlined
                    className={`${surveyMenuVisible ? 'rotate-180' : ''} transition-transform duration-300`}
                  />
                </Button>
              </Dropdown>
              <Dropdown
              ...
              >
                ...
                >
                  企业服务{' '}
                  <DownOutlined
                    className={`${serviceMenuVisible ? 'rotate-180' : ''} transition-transform duration-300`}
                  />
                </Button>
              </Dropdown>
              <Button
